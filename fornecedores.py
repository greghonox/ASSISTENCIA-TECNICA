...
# Form implementation generated from reading ui file 'C:\Users\SUPORTE05\Documents\Meus Programas\apps\ASSISTENCIA TECNICA\UI\fornecedores.ui'
#
...
from consulta_fornecedor import Consulta_fornecedor
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "CADASTRO FORNECEDORES - ASSISTENCIA TECNICA DE MANUNTEÇÃO"))
        self.groupBox.setTitle(_translate("Form", "DADOS"))
        self.label.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CÓDIGO DO FORNECEDOR</span></p></body></html>"))
        self.label.setText(_translate("Form", "CÓDIGO"))
        self.codigo.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CÓDIGO DO FORNECEDOR</span></p></body></html>"))
        self.label_2.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">DOCUMENTO DO FORNECEDOR</span></p></body></html>"))
        self.label_2.setText(_translate("Form", "CPF/CNPJ"))
        self.documento.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">DOCUMENTO DO FORNECEDOR</span></p></body></html>"))
        self.documento.setInputMask(_translate("Form", "999.999.999-99"))
        self.cpf.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CPF DO FORNECEDOR</span></p><p><br/></p></body></html>"))
        self.cpf.setText(_translate("Form", "CPF"))
        self.cnpj.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CNPJ DO FORNECEDOR</span></p><p><br/></p></body></html>"))
        self.cnpj.setText(_translate("Form", "CNPJ"))
        self.label_3.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">NOME COMPLETO DO FORNECEDOR</span></p></body></html>"))
        self.label_3.setText(_translate("Form", "NOME"))
        self.nome.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">NOME COMPLETO DO FORNECEDOR</span></p></body></html>"))
        self.groupBox_3.setTitle(_translate("Form", "CONTATO"))
        self.label_9.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CONTATO DO FORNECEDOR</span></p></body></html>"))
        self.label_9.setText(_translate("Form", "TELEFONE"))
        self.telefone.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CONTATO DO FORNECEDOR</span></p></body></html>"))
        self.telefone.setInputMask(_translate("Form", "(999)99999-9999"))
        self.label_10.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CONTATO DO FORNECEDOR</span></p></body></html>"))
        self.label_10.setText(_translate("Form", "WHASTAPP"))
        self.whatsapp.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CONTATO DO FORNECEDOR</span></p></body></html>"))
        self.whatsapp.setInputMask(_translate("Form", "(999)99999-9999"))
        self.label_11.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CONTATO DO FORNECEDOR</span></p></body></html>"))
        self.label_11.setText(_translate("Form", "E-MAIL"))
        self.email.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">CONTATO DO FORNECEDOR</span></p></body></html>"))
        self.groupBox_2.setTitle(_translate("Form", "ENDEREÇO"))
        self.label_7.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_7.setText(_translate("Form", "CIDADE"))
        self.cidade.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        ...
        self.label_12.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_12.setText(_translate("Form", "COMPLEMENTO"))
        self.complemento.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_13.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_13.setText(_translate("Form", "ESTADO"))
        self.estado.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.estado.setItemText(0, _translate("Form", "SÃO PAULO"))
        self.label_4.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_4.setText(_translate("Form", "RUA"))
        self.rua.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_5.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_5.setText(_translate("Form", "Nº"))
        self.numero.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_6.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
        self.label_6.setText(_translate("Form", "BAIRRO"))
        self.bairro.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">ENDEREÇO DO FORNECEDOR</span></p></body></html>"))
    ...
    def carregar_eventos(self):
        ...
        self.codigo.setText(str(sql.SQL().pegar_codigo_fornecedores() + 1))
        self.estado.clear()
    ...
    def abrir_consulta_categoria(self):
        ...
        ui = Consulta_fornecedor()
        ui.setupUi(Form)
        Form.exec_()
        if(ui.fornecedores_selecionado != False):
            self.carregar_fornecedor(ui.fornecedores_selecionado)


    def carregar_fornecedor(self, fornecedor):
        dados = sql.SQL().pegar_fornecedor_todos(fornecedor)[0]
        ...
        self.cadastrar.clicked.connect(self.alterar_fornecedor)
        self.excluir.disconnect()
        self.excluir.clicked.connect(self.desativar_fornecedor)
    ...
    def desativar_fornecedor(self):
        msg = QtWidgets.QMessageBox.question(None, "CADASTRO CATEGORIAS - ASSISTENCIA TECNICA DE MANUNTEÇÃO",\
                                             "DESEJA DESATIVAR O FORNECEDOR <b>{}?</b>".format(self.nome.text()))
        if(msg == QtWidgets.QMessageBox.Yes):
            if(sql.SQL().desativar_fornecedor({"codigo": self.codigo.text()})):
                QtWidgets.QMessageBox.information(None, "CADASTRO CATEGORIAS - ASSISTENCIA TECNICA DE MANUNTEÇÃO",\
                                                  "<b>FORNECEDOR {} DESATIVADO COM SUCESSO!</b>".format(self.nome.text()))
                self.Janela.close()


    def alterar_fornecedor(self):
        msg = QtWidgets.QMessageBox.question(None, "CADASTRO FORNECEDOR - ASSISTENCIA TECNICA DE MANUNTEÇÃO",\
                                             "DESEJA ALTERAR O FORNECEDOR <b>{}?</b>".format(self.nome.text()))
        if(msg == QtWidgets.QMessageBox.Yes):
            ...
            if(sql.SQL().alterar_fornecedor(SQL)):
                QtWidgets.QMessageBox.information(None, "CADASTRO CATEGORIAS - ASSISTENCIA TECNICA DE MANUNTEÇÃO",\
                                                  "<b>ALTERADO O FORNECEDOR {} COM SUCESSO!</b>".format(self.nome.text()))
                self.Janela.close()
    ...
    def cadastra(self):
        if(self.verifica_preenchimento()):
            SQL = {"cpf": self.documento.text(),
                   ...
                   "numero": self.numero.text(),
                   "bairro": self.bairro.text()}
            if(sql.SQL().inserir_fornecedores(SQL)):  self.limpar_campos()
    ...
    def limpar_campos(self):
        QtWidgets.QMessageBox.information(None, "CADASTRO FORNECEDORES - SISTEMA ASSISTENCIA TECNICA",
        "CADASTRO REALISADO COM SUCESSO DO FORNECEDORE (<b>{}</b>)!"
